//Modulo 4 devera acrescentar duas novas funcionalidades ao projeto
//1- exibir a data do ultimo acesso do usuario (cookies)
//2- autenticar o usuario para controlar o acesso aos recursos da aplicacao (sessao)
...
app.post('/login', (requisicao,resposta) => 
{
    ...
    if (usuario && senha && (usuario === 'nataly') && (senha === '123'))
    {
...
app.post('/Cadastrados',autenticar, processarCadastroVoluntarios);
